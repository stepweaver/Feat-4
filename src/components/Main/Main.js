...
const Main = () => {
  ...
  return (
    <div className="main-container">
      ...
      />
      <PokemonList pokemons={filteredPokemons.slice(0, 20)} />  // Render filtered and sliced Pokemon list
    </div>
  );
};

export default Main;  // Exporting Main component as default export
