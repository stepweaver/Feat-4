...
function LoginForm() {
  ...
  const handleSubmit = async (event) => {
    ...
    if (result.success) {  // If login is successful
      ...
      alert('Welcome back ' + result.user.get('username') + '! You are now logged in!');  // Show a welcome alert
...
export default LoginForm;  // Exporting LoginForm component as default export
